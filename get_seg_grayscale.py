...
def seg_gray_scale_main():
    ...
    bg_img = Image.fromarray(np.uint8(img)).convert("L")
    # bg_img.save("/D:/VTO/HR_VITON_main/test/test/image-parse-v3/00001_00.png")
    bg_img.save(r"D:\VTO\HR_VITON_main\test\test\image-parse-v3\00001_00.png")
