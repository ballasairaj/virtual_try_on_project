...
import time
from get_cloth_mask_copy import load_model_a, process_image_using_a_model
if __name__ == '__main__':
    model1, device1, _ = load_model_a()
    model2, device2, _ = load_model_b()
    model3, device3, _ = load_model_c()

    #process time
    for imgs in list_of_images:
        process_image_using_a_model_1(model1, device1, _)
        process_image_using_a_model_2(model2, device2, _)
        process_image_using_a_model_3(model3, device3, _)
